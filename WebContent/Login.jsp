...
<center class="panel login center-block">
 <img src="Images/dorm.png" style="width: 100%;height: 150px;"/>
      ...
      <table width="350" height="200" border="0" cellpadding="0" cellspacing="0" style="display: block;margin-top: 45px;margin-left: -20px;">
        <tr>
          <td align="center" valign="top">
             <form name="form1" action="GoLogin.action" method="post" onSubmit="return LogincheckMessage()">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td align="left" class="text1">
                      ...
                      <input type="text" name="check" id="check" style="display: block;float: left; width: 100%;
      height: 35%;"/>

                      </div>
                    <span class="check" style="display: block;float: left;border: red 1px solid;width:45px;height: 55%;font-size: 1.2em;"></span>
                  </td>
                  </tr>
                <tr>
...
<script>
  ...
  function LogincheckMessage(){
    ...
    if(form1.check.value!=codecheck){
      alert("验证码输入错误！");
      return false;
    }
