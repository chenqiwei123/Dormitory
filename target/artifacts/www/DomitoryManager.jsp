...
<%@ page import="com.dao.DomitoryDao" %>
<%
              ...
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"  class="t1">
                    ...
                    <td bgcolor="#D5E4F4"><strong>寝室长电话</strong></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr align="center">
                      <%
                        int qq=new DomitoryDao().GetAllListCount().get(0).getDorm_Row();
                        for (int i=0;i<qq/16+1;i++){
//                        HttpSession session = ServletActionContext.getRequest().getSession();
                      %><td><a href="DomitoryManager.action?a=<%=i%>" <%session.setAttribute("number111", i*16);%>><%if(i<9){%>
